...
I love canned beans and eat them regularly, but cooking beans from dry
gives you way more control over their flavor and texture. If you find yourself
with an hour or two on a lazy weekend day, working from home, or even with some
hours to spare after you prepare dinner, all can be a great time to cook dried beans
because they're pretty hands off once you get them going.

Below is my base method that's gotten me off the ground. Give it a try and take
a look at the troubleshooting I've got below the method to fix anything that went
wrong. Like so much with cooking, you probably won't get cooking from dried
beans right on the first try, but keep at it. Soon enough, you will get a pot of creamy,
delicious beans for your effort.
...
if you don't know how old your beans are. If you got them from the
supermarket, you do not know their age. As beans get older, they continue drying out and that
means longer cooking times. You do not have to do this step if you have fresher
beans from a seller that has identified them as this year's harvest. Even still,
...
that salt is going into your beans. _Contrary to popular belief_ adding salt
...
3. Fill bean pot with water so there is about one inch of water above the beans
...
blends, fresh herbs, olive oil and pepper; more ideas on this
[here](#start-experimenting). Add whatever you want (well almost) to flavor the beans. _Do not_
add any acidic seasonings at this point. Acidic ingredients change how
the beans cook, will make them take longer and will toughen them up. If you want the
...
it's 11 o'clock at night kind of simmer. You want just a few delicate bubbles
breaking the surface of your bean cooking liquid. This makes sure the beans
cook evenly and stay intact as they cook. Don't get impatient! I have been there
many a time. Your beans will eventually cook and turning up the stove too high will
just turn them into a pile of mush.

That said, as I have experienced before, you can undershoot the simmer level. If no bubbles
are coming to the surface of your liquid, you are not at a simmer and need to turn the heat up.
This is the touchiest part of this process and will take some getting used to before you
know exactly where on the stove to leave your pot.

7. Stir baby stir

Whenever you think of it over the next couple of hours, stir the
...
cozy hot spots and the frigid corners of your pot that just won't heat up.

8. Start tasting beans. When you taste five and they're all creamy, you're done

I heard an awesome trick on the Home Cooking podcast the other day. When you
are tasting the beans to see if they are done, you should taste five
...
way through five creamy beans, you can be reasonably sure that the pot is done. If you
...
everything up and serve your beans. You can also top them with anything crunchy,
like breadcrumbs, or fresh herbs like cilantro or parsley. Just think about
...
may not have cooked them long enough. This was a huge problem for me when I
first started cooking beans from dry. I read all these recipes that said my beans should
...
beans. This can be an issue in the grocery bulk section, where stores often mix up old
...
higher turnover. Obviously I'll always tout the local guys, like [Baer's
Best](http://baersbest.com/). Don't let the website fool you, they are amazing
beans. Check out the [links](#small-bean-sellers) at the bottom for more small bean sellers.
Amazon does also have a pretty good bean selection that most likely has higher turnover than
your grocery aisle.
...
perfectly intact. If around half of them are burst though, you might want to
cook them less.
...
taste more evenly seasoned.

Remember, you can still add more seasoning at the end of
...
I know I said to keep the heat low, but it is possible to cook the beans at too low
...
Next time, cook them on a little higher temperature. If you didn't soak
your beans, make sure you soak them!

### Start experimenting

- Add a half an onion and some pork/bacon fat to black beans
...
- Render some bacon, add a chopped onion and 1/4 cup of molasses, bake at
  325&#xb0;F

Before you've added the beans into your cooking pot, render out the fat from a
half pound of bacon lardons, or bacon slices cut into pieces a quarter inch wide.
...
by an inch of water. Add in a quarter cup of molasses (more if you like
...
depending on how thick the bean skin is. When they're done cooking, stir in a
...
adds incredible amounts of flavor to anything that it's in. The depth and
freshness of flavor that it adds to anything it's in is hard to overstate. If you are lucky
enough to have some, add that into your beans.

The ingredients in sofrito can be hard to find depending on where you are though, so if you
don't have access to them or someone to show you how to make it, any number of different
herbs are delicious
...
As you're adding herbs, feel free to add ground spices or spice blends. Add cumin,
...
their website and order directly from them. As they've gained in popularity,
it's gotten harder to find their beans in stock on their site though. If you have any specialty food
...
are a great product and cook up super evenly.
